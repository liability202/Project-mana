                ...
                <div key={order.id} className={`bg-white border rounded-xl p-5 ${overdue ? 'border-terra' : 'border-ivory-3'}`}>
                  <div className="flex items-start justify-between flex-wrap gap-3 mb-3">
                    <div>
                      ...
                      <div className="text-xs text-ink-4 mt-0.5 whitespace-normal break-words max-w-[420px]">{order.address}, {order.city}{order.state ? `, ${order.state}` : ''} - {order.pincode}</div>
                ...
                <table className="w-full text-sm">
                  <thead className="bg-ivory-2 border-b border-ivory-3">
                    <tr>
                      ...
                      <th className="text-left px-4 py-3 text-xs uppercase tracking-wide text-ink-4 font-normal">Revenue (Subtotal)</th>
